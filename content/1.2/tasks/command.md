...
The command template is evaluated *after* all of the inputs are staged and before the outputs are evaluated. The command template is evaluated similarly to [multi-line strings](@/1.2/types/primitive-types/strings.md#multi-line-strings):
