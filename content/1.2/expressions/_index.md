...
An expression is a compound statement that consists of literal values, identifiers (references to [declarations](@/1.2/expressions/declarations.md) or [call](@/1.2/workflows/call.md) outputs), [built-in operators](@/1.2/expressions/operators.md) (e.g., `+` or `>=`), and calls to [standard library functions](@/1.2/standard-library/_index.md).
