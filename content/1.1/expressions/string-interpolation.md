...
description = "String interpolation, placeholder coercion, and optional value concatenation"
weight = 70
+++
...
Compound types cannot be implicitly converted to strings. To convert an `Array` to a string, use the [`sep`](@/1.1/standard-library/array-string-functions/sep.md) function: `~{sep(",", str_array)}`.
