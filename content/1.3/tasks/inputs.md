...
- When a WDL author uses a `File` or `Directory` input in their [Command Section](@/1.3/tasks/command.md), the absolute path to the localized file/directory is substituted when that declaration is referenced.
